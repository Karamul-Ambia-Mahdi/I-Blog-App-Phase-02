    ...
    <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('home.index') }}" class="text-gray-400 hover:text-white transition">Home</a></li>
                    <li><a href="{{ route('home.categories') }}" class="text-gray-400 hover:text-white transition">Categories</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('home.categories') }}" class="text-gray-400 hover:text-white transition">Web Development</a></li>
