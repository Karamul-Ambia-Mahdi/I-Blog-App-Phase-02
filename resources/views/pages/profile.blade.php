            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="border-b border-gray-200 pb-6 mb-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('single-blog') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View Article</a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div class="border-b border-gray-200 pb-4">
                        <p class="text-sm text-gray-600 mb-1">On <a href="{{ route('single-blog') }}"
                                class="text-blue-600 hover:underline">The Future of Web Development</a></p>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        <p class="text-sm text-gray-600 mb-1">On <a href="#"
                                class="text-blue-600 hover:underline">React 18 Features</a></p>
